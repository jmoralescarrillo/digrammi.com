    ...
    <div class='padding-cont'>
        ...
        <div class='alignment' style='float:left;margin-right:20px;'>
            ...
            <select class='newselect' name='pagebuilder[modules][$moduleid][heading_alignment]'>
                " . get_select_options($pbconfig['all_available_headers_alignment'], $pagebuilder['modules'][$moduleid]['heading_alignment']) . "
            </select>
        </div>
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_select($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Ajax", "ajax", "200px", array("on", "off")) . "
        " . get_module_settings_part_select($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Filter", "filter", "200px", array("on", "off")) . "
        " . get_module_settings_part_select($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Category", "category", "200px", $available_categories) . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Margin-bottom", "padding_bottom", "200px", $pbconfig['available_padding_after_module']) . "
    </div>
    " . get_module_settings_part_done_btn() . "
...
<div class='pop_scrollable_area'>
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Properties", "properties", "200px", array("stretch" => "Stretch", "" => "Pattern")) . "
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Full width", "fullwidth_map", "200px", array("no" => "No", "yes" => "Yes")) . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Margin-bottom", "padding_bottom", "200px", $pbconfig['available_padding_after_module']) . "
    </div>
    " . get_module_settings_part_done_btn() . "
</div>
