    ...
    public function register_shortcode($shortcodeName)
    {
        function shortcode_partners($atts, $content = null)
        {
            ...
            if (strlen($heading_text) > 0) {
                echo "<div class='bg_title'><a href='javascript:void(0)' class='btn_carousel_left'></a><" . $heading_size . " style='" . $custom_color . "' class='headInModule'>{$heading_text}</" . $heading_size . "><a href='javascript:void(0)' class='btn_carousel_right'></a></div>";
            }
