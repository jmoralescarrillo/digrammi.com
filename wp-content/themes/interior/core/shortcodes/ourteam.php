					...
					<li>
                        <div class="item">
							...
							if (has_post_thumbnail()) {
								$compile .= '<img src="'.aq_resize($featured_image[0], "270", "190", true).'" alt="'.get_the_title().'" />';
							} else {
								$compile .= '<img src="'.aq_resize(IMGURL.'/core/team-unknown.jpg', "270", "190", true).'" alt="'.get_the_title().'" />';
							}
