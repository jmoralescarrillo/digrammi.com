    ...
    <div id="comment-<?php comment_ID(); ?>" class="stand_comment">
        ...
        <div class="thiscommentbody">
            <div class="comment_info">
            	<ul>
                    <li><span class="author_name"><?php echo ((get_theme_option("translator_status") == "enable") ? get_text("posted_by") : __('Posted by','theme_localization')); ?> <?php printf('%s', get_comment_author_link()) ?> <?php edit_comment_link('(Edit)', '  ', '') ?></span></li>
                    <li><span class="date"><?php printf('%1$s at %2$s', get_comment_date("d M Y"), get_comment_time()) ?></span></li>
                    <li><?php comment_reply_link(array_merge($args, array('before' => '', 'after' => '', 'depth' => $depth, 'reply_text' => (get_theme_option("translator_status") == "enable") ? get_text("translator_reply_value") : __('Reply','theme_localization'), 'max_depth' => $max_depth_comment))) ?></li>
                </ul>
            </div>
